...
export class App {
  ...
  configureRouter(config, router) {
    ...
    config.map([
      ...
      { route: 'caesar-cipher', name: 'caesar-cipher', moduleId: 'pages/caesar-cipher', title: 'Caesar Cipher', nav: false }, 
      { route: 'cipher-disk',   name: 'cipher-disk',   moduleId: 'pages/cipher-disk',   title: 'Cipher Cipher', nav: false }  
    ]);
  }
}
